...
public class ReaderViewPagerTransformer implements ViewPager.PageTransformer {
    ...
    public void transformPage(View page, float position) {
        ...
        //posisi page, untuk position layar yang ditampilkan 0, layar kiri -1, layar kanan 1
        TextView textView4=(TextView)page.findViewById(R.id.position);
        textView4.setText(String.valueOf(position));

        TextView textView=(TextView)page.findViewById(R.id.alpha);
        textView.setText(String.valueOf(alpha));

        TextView textView1=(TextView)page.findViewById(R.id.transition);
        textView1.setText(String.valueOf(translationX));

        TextView textView2=(TextView)page.findViewById(R.id.scale);
        textView2.setText(String.valueOf(scale));

        //alpha biar terlihat page semakin transparan
        page.setAlpha(alpha);
        //translasi dari page yang ingin di swipe, dari kanan 0-1000, dari kiri 1000-0
        page.setTranslationX(translationX);
        //scale untuk view tampak semakin kecil
